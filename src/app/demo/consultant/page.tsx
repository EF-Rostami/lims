  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 to-indigo-50 flex items-center justify-center p-6">
      <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-10 max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Consultant Demo</h1>
        <p className="text-gray-500 text-sm mb-8">
          Connecting you to the consultant workspace — Dairy Testing Lab…
        </p>

        {!error ? (
          <>
            <div className="flex items-center justify-center gap-3 text-sky-600 mb-6">
              <Loader2 className="w-5 h-5 animate-spin" />
              <span className="text-sm font-medium">Signing in as demo consultant</span>
            </div>
            <div className="space-y-2 text-xs text-gray-400">
              <div className="flex items-center gap-2 justify-center">
                <ShieldCheck className="w-3.5 h-3.5 text-green-500" />
                Consultant role — full project and meeting access
              </div>
              <div className="flex items-center gap-2 justify-center">
                <ShieldCheck className="w-3.5 h-3.5 text-green-500" />
                Pre-populated ISO 17025 accreditation project
              </div>
            </div>
          </>
        ) : (
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-sky-600 text-white py-2.5 rounded-xl text-sm font-semibold hover:bg-sky-700 transition-colors"
            >
              Try again
            </button>
            <a href="/for-consultants" className="block text-sm text-gray-500 hover:text-gray-700 transition-colors">
